...
public class Coachmain extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    /**
     * when the activity starts.using query for coach name
     */
    ...
    /**
     * after the activity starts query reading all the  correct info and setting at the right place
     * reading from database the coach- name teams etc...
     * <p>

     * @return	name of team and user, list of games 		.
     */
                            ...
                            for (DataSnapshot ds : dataSnapshot.getChildren()) {
                                ...
                                refGame.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        /**
                                         * ordering the list the sooner the game- first
                                         */
    ...
    /**
     * on click for games list
     * Reading from database the game class and setting alert dialog with the info
     * <p>
     *only coach can delete a game
     * @return	alert dialog with info about game		.
     */
    ...
    /**
     * this create dialog where coach can sent updates to team/all teams/ cancel
     * using spinner for choosing team
     * using single value vent listener in ref teams
     * @param view
     */
    ...
    /**
     * only coach can add sevral teams
     * @param view
     */
